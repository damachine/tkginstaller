...
_help() {
    ...
    ${TKG_ECHO} "${TKG_GREEN} Shortcuts:${TKG_RESET} l=linux, n=nvidia, m=mesa, w=wine, p=proton"
    ${TKG_ECHO} " "
...
_handle_confg() {
    ...
    ${TKG_ECHO} "${TKG_BLUE} 🔧 Opening external $TKG_CONFIG_NAME configuration file...${TKG_RESET}"
    sleep 1
    clear
